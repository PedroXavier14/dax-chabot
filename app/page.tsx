...
const ChatMessage = ({text, from}: MessageProps) => {
  return (
    <>
      {
        from == Creator.Me && (
          <div className="bg-zinc-100 p-4 rounded-lg flex mt-4 items-center whitespace-pre-wrap">
      ...
      {
         from == Creator.Bot && (
          <div className="bg-dax-400 p-4 rounded-lg flex mt-4 items-center whitespace-pre-wrap">
